  ...
  return (
    <div className='min-h-screen w-full flex flex-row bg-[#0a0a0a] text-white font-sans selection:bg-white/20'>
          ...
          <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">Name</label>
                <input 
                  type="text" 
                  placeholder="Jane Smith"
                  className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-3 text-sm focus:outline-none focus:border-zinc-600 transition-colors"
                />
              </div>
              {/* Email */}
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">Email</label>
                <input 
                  type="email" 
              ...
              {/* Phone */}
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">Phone Number</label>
                <input 
                  type="text" 
              ...
              {/* People */}
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">People</label>
                <input 
                  type="text" 
                  placeholder="1-10"
                  className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-3 text-sm focus:outline-none focus:border-zinc-600 transition-colors"
              ...
              {/* Date */}
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">Date</label>
                <input 
                  type="date" 
                  className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-3 text-sm focus:outline-none focus:border-zinc-600 transition-colors appearance-none"
                  style={{ colorScheme: 'dark' }}
                />
              </div>
              {/* Time */}
              <div className="flex flex-col gap-2">
                <label className="text-zinc-300 font-serif italic text-sm">Time</label>
                <input 
                  type="time" 
                  className="bg-[#0a0a0a] border border-zinc-800 rounded-xl p-3 text-sm focus:outline-none focus:border-zinc-600 transition-colors"
                  style={{ colorScheme: 'dark' }}
            ...
            <button className="w-full bg-[#fdfcf5] text-black py-4 rounded-xl font-medium text-sm hover:bg-[#f0eee0] transition-colors mt-2">
              Make Reservation
            </button>
          </form>
        </div>
      ...
      <style jsx global>{`
        ...
        /* Ensures the date/time picker icons look clean on dark bg */
