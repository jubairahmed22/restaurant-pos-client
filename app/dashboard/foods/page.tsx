...
export default function FoodTablePage() {
  ...
  return (
    <div className="grid grid-cols-12 gap-6">
      ...
      ========================= */}
      <div className="col-span-12 lg:col-span-4 bg-white p-5 rounded-xl border">
        ...
        >
          ...
          {/* IMAGE UPLOADER */}
          <label className="block border p-3 rounded-lg text-center cursor-pointer">
            <input
              type="file"
              hidden
              onChange={(e) =>
...
<Dialog open={editModal} onOpenChange={setEditModal}>
  <DialogContent className="bg-slate-900 text-white max-w-xl">
    ...
    >
      ...
      {/* CATEGORY (ADDED) */}
      <select
        className="w-full border border-slate-700 bg-slate-800 text-white rounded-lg px-3 py-2 text-sm focus:outline-none"
        {...register('category')}
      >
