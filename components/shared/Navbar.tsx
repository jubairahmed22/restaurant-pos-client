  ...
  return (
    <header className="sticky top-0 bg-white border-b border-slate-100 z-50 px-6 py-4">
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        <Link href="/" className="flex items-center gap-2 text-2xl font-black text-orange-600 tracking-tight">
        ...
        <div className="flex items-center gap-6">
          ...
          {user?.role === 'admin' && (
            <Link href="/dashboard" className="flex items-center gap-1 text-sm font-semibold text-slate-600 hover:text-orange-600 transition">
              <LayoutDashboard size={16} />
              <span>Dashboard</span>
            </Link>
          )}

          <Link href="/cart" className="relative p-2.5 bg-orange-50 rounded-full text-orange-600 hover:bg-orange-100 transition">
          ...
          {user ? (
            ...
            <Link href="/login" className="flex items-center gap-2 bg-slate-900 hover:bg-slate-800 text-white text-sm font-medium px-4 py-2 rounded-xl transition">
              <User size={16} />
              <span>Sign In</span>
            </Link>
          )}
