...
export default function OrderItemMenu({
  ...
  return (
    <div className="group relative overflow-hidden rounded-3xl border border-white/10 bg-[#111111] p-4 transition-all duration-300 hover:border-white/20 hover:bg-[#161616]">
